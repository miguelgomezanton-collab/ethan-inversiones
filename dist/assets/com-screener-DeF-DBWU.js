const F=[{ticker:"GC=F",name:"Oro",cat:"metales",type:"futures",emoji:"🥇"},{ticker:"GLD",name:"Oro · SPDR Gold Trust",cat:"metales",type:"etf",emoji:"🥇"},{ticker:"IAU",name:"Oro · iShares Gold ETF",cat:"metales",type:"etf",emoji:"🥇"},{ticker:"SI=F",name:"Plata",cat:"metales",type:"futures",emoji:"🥈"},{ticker:"SLV",name:"Plata · iShares Silver",cat:"metales",type:"etf",emoji:"🥈"},{ticker:"PL=F",name:"Platino",cat:"metales",type:"futures",emoji:"⬜"},{ticker:"PA=F",name:"Paladio",cat:"metales",type:"futures",emoji:"🔘"},{ticker:"PPLT",name:"Platino · Sprott ETF",cat:"metales",type:"etf",emoji:"⬜"},{ticker:"CL=F",name:"Petróleo WTI",cat:"energia",type:"futures",emoji:"🛢️"},{ticker:"BZ=F",name:"Petróleo Brent",cat:"energia",type:"futures",emoji:"🛢️"},{ticker:"USO",name:"Petróleo · US Oil Fund",cat:"energia",type:"etf",emoji:"🛢️"},{ticker:"UCO",name:"Petróleo · ProShares 2x",cat:"energia",type:"etf",emoji:"🛢️"},{ticker:"NG=F",name:"Gas Natural",cat:"energia",type:"futures",emoji:"🔥"},{ticker:"UNG",name:"Gas Natural · US Fund",cat:"energia",type:"etf",emoji:"🔥"},{ticker:"RB=F",name:"Gasolina RBOB",cat:"energia",type:"futures",emoji:"⛽"},{ticker:"HO=F",name:"Gasóleo / Fuel Oil",cat:"energia",type:"futures",emoji:"🏭"},{ticker:"HG=F",name:"Cobre",cat:"industriales",type:"futures",emoji:"🟤"},{ticker:"CPER",name:"Cobre · US Copper ETF",cat:"industriales",type:"etf",emoji:"🟤"},{ticker:"COPX",name:"Cobre · Mineras ETF",cat:"industriales",type:"etf",emoji:"🟤"},{ticker:"ALI=F",name:"Aluminio",cat:"industriales",type:"futures",emoji:"🔩"},{ticker:"ZNC=F",name:"Zinc",cat:"industriales",type:"futures",emoji:"⚙️"},{ticker:"ZW=F",name:"Trigo",cat:"agricultura",type:"futures",emoji:"🌾"},{ticker:"WEAT",name:"Trigo · Teucrium ETF",cat:"agricultura",type:"etf",emoji:"🌾"},{ticker:"ZC=F",name:"Maíz",cat:"agricultura",type:"futures",emoji:"🌽"},{ticker:"CORN",name:"Maíz · Teucrium ETF",cat:"agricultura",type:"etf",emoji:"🌽"},{ticker:"ZS=F",name:"Soja",cat:"agricultura",type:"futures",emoji:"🫘"},{ticker:"SOYB",name:"Soja · Teucrium ETF",cat:"agricultura",type:"etf",emoji:"🫘"},{ticker:"SB=F",name:"Azúcar",cat:"agricultura",type:"futures",emoji:"🍬"},{ticker:"CANE",name:"Azúcar · Teucrium ETF",cat:"agricultura",type:"etf",emoji:"🍬"},{ticker:"KC=F",name:"Café",cat:"agricultura",type:"futures",emoji:"☕"},{ticker:"JO",name:"Café · iPath ETF",cat:"agricultura",type:"etf",emoji:"☕"},{ticker:"CC=F",name:"Cacao",cat:"agricultura",type:"futures",emoji:"🍫"},{ticker:"NIB",name:"Cacao · iPath ETF",cat:"agricultura",type:"etf",emoji:"🍫"},{ticker:"CT=F",name:"Algodón",cat:"agricultura",type:"futures",emoji:"🤍"},{ticker:"LE=F",name:"Ganado Bovino",cat:"agricultura",type:"futures",emoji:"🐄"},{ticker:"HE=F",name:"Cerdos",cat:"agricultura",type:"futures",emoji:"🐷"},{ticker:"GSG",name:"Commodities · iShares S&P",cat:"all",type:"etf",emoji:"🌐"},{ticker:"PDBC",name:"Commodities · Invesco",cat:"all",type:"etf",emoji:"🌐"},{ticker:"DJP",name:"Commodities · iPath",cat:"all",type:"etf",emoji:"🌐"},{ticker:"COMT",name:"Commodities · iShares GSCI",cat:"all",type:"etf",emoji:"🌐"}],G=[{key:"all",label:"Todos",emoji:"🌐"},{key:"metales",label:"Metales Preciosos",emoji:"🥇"},{key:"energia",label:"Energía",emoji:"⚡"},{key:"industriales",label:"Met. Industriales",emoji:"⚙️"},{key:"agricultura",label:"Agricultura",emoji:"🌾"}],D=11,V=[i=>`https://api.allorigins.win/raw?url=${encodeURIComponent(i)}`,i=>`https://corsproxy.io/?${encodeURIComponent(i)}`,i=>`https://soft-field-156f.miguel-gomez-anton.workers.dev/?url=${encodeURIComponent(i)}`,i=>`https://api.codetabs.com/v1/proxy?quest=${encodeURIComponent(i)}`];async function _(i){var c,r,u,l,d,s,p;const f=`https://query1.finance.yahoo.com/v8/finance/chart/${i}?interval=1d&range=10y&events=history`;for(const t of V)try{const a=await fetch(t(f),{signal:AbortSignal.timeout(8e3)});if(!a.ok)continue;const n=await a.text();let o;try{o=JSON.parse(n)}catch{continue}const m=(r=(c=o==null?void 0:o.chart)==null?void 0:c.result)==null?void 0:r[0];if(!m)continue;const y=(l=(u=m.indicators)==null?void 0:u.quote)==null?void 0:l[0];if(!y)continue;const h=((p=(s=(d=m.indicators)==null?void 0:d.adjclose)==null?void 0:s[0])==null?void 0:p.adjclose)||y.close,E=h.map((v,g)=>y.close[g]&&v?v/y.close[g]:1);return{timestamps:m.timestamp,opens:y.open.map((v,g)=>v*E[g]),highs:y.high.map((v,g)=>v*E[g]),lows:y.low.map((v,g)=>v*E[g]),closes:h,vols:y.volume}}catch{}throw new Error("Sin datos")}function T(i,f){const c=2/(f+1),r=new Array(i.length).fill(null);let u=i.findIndex(l=>l!=null&&!isNaN(l));if(u<0)return r;r[u]=i[u];for(let l=u+1;l<i.length;l++){const d=i[l]!=null&&!isNaN(i[l])?i[l]:r[l-1];r[l]=d*c+r[l-1]*(1-c)}return r}function x(i){const f=T(i,12),c=T(i,26),r=f.map((u,l)=>u!=null&&c[l]!=null?u-c[l]:null);return{m:r,sl:T(r.map(u=>u??0),9)}}function $(i,f=14){const c=new Array(i.length).fill(null);if(i.length<f+1)return c;let r=0,u=0;for(let s=1;s<=f;s++){const p=i[s]-i[s-1];p>0?r+=p:u-=p}let l=r/f,d=u/f;c[f]=d===0?100:100-100/(1+l/d);for(let s=f+1;s<i.length;s++){const p=i[s]-i[s-1];l=(l*(f-1)+(p>0?p:0))/f,d=(d*(f-1)+(p<0?-p:0))/f,c[s]=d===0?100:100-100/(1+l/d)}return c}function P(i,f,c,r){const u=c.map((d,s)=>{if(s<r-1)return null;const p=Math.max(...i.slice(s-r+1,s+1)),t=Math.min(...f.slice(s-r+1,s+1));return p===t?50:(d-t)/(p-t)*100}),l=T(u,3);return{k:l,d:T(l.map(d=>d??0),3)}}function U(i,f,c,r,u,l,d){const s={};i.forEach((t,a)=>{const n=new Date(t*1e3);let o;if(d==="W"){const m=n.getDay(),y=n.getDate()-m+(m===0?-6:1),h=new Date(+n);h.setDate(y),o=h.toISOString().slice(0,10)}else o=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`;s[o]?(s[o].h=Math.max(s[o].h,c[a]),s[o].l=Math.min(s[o].l,r[a]),s[o].c=u[a],s[o].v+=l[a]):s[o]={o:f[a],h:c[a],l:r[a],c:u[a],v:l[a]}});const p=Object.keys(s).sort();return{dates:p,opens:p.map(t=>s[t].o),highs:p.map(t=>s[t].h),lows:p.map(t=>s[t].l),closes:p.map(t=>s[t].c),vols:p.map(t=>s[t].v)}}function q(i){const{timestamps:f,opens:c,highs:r,lows:u,closes:l,vols:d}=i,s=l.length,p=d[s-1]||0,t=d.slice(-D).reduce((b,z)=>b+(z||0),0)/D,a=U(f,c,r,u,l,d,"W"),n=U(f,c,r,u,l,d,"M"),o=n.closes.length-1,m=a.closes.length-1,y=s-1,h=x(n.closes),E=P(n.highs,n.lows,n.closes,89),v=P(n.highs,n.lows,n.closes,8),g=$(n.closes),C=T(n.closes,10),e=x(a.closes),k=P(a.highs,a.lows,a.closes,89),O=$(a.closes),I=T(a.closes,20),j=x(l),S=$(l),A=[h.m[o]>0&&h.m[o]>h.sl[o],E.k[o]>80&&E.k[o]>E.d[o]||E.k[o]>92,g[o]>65,v.k[o]>78,C[o]&&n.closes[o]>C[o]],M=[e.m[m]>0&&e.m[m]>e.sl[m],k.k[m]>85&&k.k[m]>k.d[m]||k.k[m]>92,O[m]>67,I[m]&&a.closes[m]>I[m]],L=A.every(b=>b),R=M.every(b=>b),B=j.m[y]>j.sl[y]&&j.m[y-1]<=j.sl[y-1]&&S[y]>57&&j.m[y]>0,N=A.filter(b=>b).length+M.filter(b=>b).length+(B?1:0);let w="watching";return L&&R&&B?w="ready":L&&R?w="diario":N>=7&&(w="close"),{score:N,estado:w,price:l[y],lastVol:p,avgVol11:t}}async function H(i,{actionsSlot:f}){var p;let c=[],r=!1,u="all";f.innerHTML=`
  ...
  `;function l(t){try{const a=JSON.parse(localStorage.getItem("ethan_watchlist_com_v1")||"[]");a.includes(t)||(a.push(t),localStorage.setItem("ethan_watchlist_com_v1",JSON.stringify(a)));const n=document.querySelector(`[data-wl="${t}"]`);n&&(n.textContent="✓",n.style.color="var(--green)",n.disabled=!0)}catch{}}function d(){var v,g,C;const t=parseInt(((v=document.getElementById("cm-filter-score"))==null?void 0:v.value)||"7"),a=((g=document.getElementById("cm-filter-tipo"))==null?void 0:g.value)||"all",n=((C=document.getElementById("cm-filter-estado"))==null?void 0:C.value)||"all",o=c.filter(e=>!(e.score<t||u!=="all"&&e.cat!==u||a!=="all"&&e.type!==a||n!=="all"&&e.estado!==n)).sort((e,k)=>k.score-e.score);G.forEach(e=>{const k=document.getElementById(`cm-badge-${e.key}`);if(!k)return;const O=c.filter(S=>e.key==="all"||S.cat===e.key),I=O.filter(S=>S.estado==="ready").length,j=O.filter(S=>S.score>=7).length;O.length>0&&j>0?(k.textContent=I>0?I:j,k.style.background=I>0?"var(--green)":"var(--text3)",k.style.display="inline"):k.style.display="none"});const m=document.getElementById("cm-results");if(!m)return;if(o.length===0){m.innerHTML=`<div class="sc2-empty">${c.length>0?"Ningún activo cumple los filtros actuales":"Pulsa Escanear para analizar el universo de commodities"}</div>`;return}const y=e=>e>=9?"var(--green)":e>=7?"var(--amber)":"var(--text3)",h={ready:"🟢 LISTO",diario:"⏳ ESPERA DIARIO",close:"🔶 CERCA",watching:"👁 VIGILANDO"},E=e=>e==="ready"?"var(--green)":e==="diario"?"var(--amber)":"var(--text3)";m.innerHTML=`
